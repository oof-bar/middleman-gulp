...
var paths = {
  scripts: {
    main: ['source/coffee/app.coffee'],
    listen: ['source/coffee/**/*.coffee'],
    out: 'source/javascripts'
  },
  stylesheets: {
    main: ['source/sass/app.sass'],
    listen: ['source/sass/**/*.sass'],
  ...
  scripts: function (mangle) {
    return gulp.src(paths.scripts.main)
      .pipe(coffeeify({
        options: {
          debug: !mangle,
          paths: [__dirname + '/node_modules', __dirname + '/source/coffee']
        }
      }))
